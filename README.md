...
3. An agent picks one quote and says why.
4. The quote is stored for that day, and the reason lands on the activity feed.

## What you see

- **Overview** shows today's quote and its author.
